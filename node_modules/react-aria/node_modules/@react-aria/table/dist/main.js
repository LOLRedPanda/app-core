...
function $25d14c0f8fad722e$export$25bceaac3c7e4dc7(props, state, ref) {
    ...
    return {
        gridProps: (0, $kJQf8$reactariautils.mergeProps)(gridProps, descriptionProps, // If table is empty, make sure the table is tabbable
...
function $16d645f9e2153641$export$52994e973806c219(props, state, layoutState, ref) {
    ...
    let ariaProps = {
        ...
        "aria-labelledby": `${id} ${(0, $6acf696f746f932c$export$37cd4213f2ad742e)(state, item.key)}`,
    ...
    return {
        resizerProps: (0, $kJQf8$reactariautils.mergeProps)(keyboardProps, moveProps, pressProps),
