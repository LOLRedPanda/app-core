  ...
  return (
    <div className='w-full col-span-1 relative lg:h-[70vh] h-[50vh] m-auto p-4 border rounded-lg bg-red-100 overflow-scroll'>
        ...
        <ul>
            ...
            {teamData.members.jungle !== null ? <Member image={Top} name={teamData.members.jungle} position='Jungle' />: <Member image={Jungle} name="" position='Jungle' />}
            {teamData.members.mid !== null ? <Member image={Top} name={teamData.members.mid} position='Mid' />: <Member image={Mid} name="" position='Mid' />}
            {teamData.members.adc !== null ? <Member image={Top} name={teamData.members.adc} position='ADC' />: <Member image={ADC} name="" position='ADC' />}
            {teamData.members.support !== null ? <Member image={Top} name={teamData.members.support} position='Support' />: <Member image={Support} name="" position='Support' />}
